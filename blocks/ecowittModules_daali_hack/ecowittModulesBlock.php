<?php
	...
	$data['modules'] = array (
		...
		"WH45"    => array("module_name" => "WH45",   "battery_percent" => ($apiData['CO2_1'] * 19), "set" => $apiData['CO2_1'], "last_seen" => $apiData['U'], "data_type" => array("pp25"), "firmware" => $firmware, "rf_status" => (150 - ($apiData['CO2_1'] * 18)) ),
